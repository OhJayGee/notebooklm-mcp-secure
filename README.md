...
**Latest: v2026.3.4** — Whole-repo external review fixes. Tests: 777 → 804. 11 distinct findings (Codex + Gemini 3.1 Pro, deduplicated) patched with regression tests pinning each fix.
